...
if [[ $# != 1 ]]; then
    echo "Usage: ./run_lexer.sh java|cpp"
    echo "Example: cat test/demo/simple.c1 | ./run_lexer.sh java"
fi
...
if [[ $1 == "java" ]]; then
    ...
    g++ -std=c++17 ../src/lexer.cpp C1Lexer.cpp -I../src/antlr4-runtime-4.13.1 -I. -lantlr4-runtime -o c1lexer
    ./c1lexer
fi
